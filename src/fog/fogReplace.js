...
const fogFrag = `
  ...
  vec3 fogCol = mix( gl_FragColor.rgb, mix(fogNearColor, fogColor, fogFactor), fogFactor );
  gl_FragColor = vec4(v * .01 + fogCol, 1.);	
#endif
